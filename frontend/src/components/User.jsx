...
//     if (!isValidFullName(e.target.value) || e.target.value.length >= 255)
//       return;
//     setFullName(e.target.value); // Update state only if it matches the pattern
//     setJustVerify(true);
//   };

//   const [isProfilePictureSelectOpen, setIsProfilePictureSelectOpen] =
//     useState(false);
...
//   );
//   const [isLoadingProfileImageSave, setIsLoadingProfileImageSave] =
//     useState(false);

//   const handleSaveProfileImage = async () => {
//     setIsLoadingProfileImageSave(true);
//     try {
//       const results = await POST("/user/update-profile-image", {
...
//                   hoveredAvatar
//                     ? hoveredAvatar
//                     : getAvatar(selectedProfileImage)
//                 }
//                 imgProps={{
...
//                     fontSize: 40,
//                     border:
//                       selectedProfileImage == userInfo.image
//                         ? "1px solid black"
//                         : "1px solid black",
//                     "&:hover": {
//                       border: "2px solid black",
...
//       >
//         <Box sx={{ m: 1 }}>
//           <Typography fontWeight="bold" sx={{ color: "#666666" }}>
//             {userInfo.email || "email: N/A"}
//           </Typography>
//         </Box>
...
//           }}
//         >
//           <Box sx={{ m: 1, my: 2, display: "flex", alignItems: "center" }}>
...
//             sx={{ color: "#666666" }}
//           >
//             Created On: {DateFormatter(userInfo.createdAt) || "createdAt: N/A"}
//           </Typography>
//           <Typography
//             fontWeight="bold"
//             variant="caption"
//             sx={{ color: "#666666" }}
//           >
//             Updated On: {DateFormatter(userInfo.updatedOn) || "updatedOn: N/A"}
//           </Typography>
//         </Box>
//         <Box
//           sx={{
